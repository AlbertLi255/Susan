...
const (
	UpdateIconName = "susan_tray_upgrade.ico"
	IconName       = "susan_tray.ico"
	ClassName      = "SusanClass"
)
...
func iconBytesToFilePath(iconBytes []byte) (string, error) {
	...
	iconFilePath := filepath.Join(os.TempDir(), "susan_temp_icon_"+dataHash)
...
func (t *winTray) setIcon(src string) error {
	...
	if toolTipUTF16, err := syscall.UTF16FromString("Susan"); err == nil {
