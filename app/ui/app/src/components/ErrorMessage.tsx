...
const renderWithLinks = (text: string) => {
  ...
  // Split text by URLs
  // for example if the text is "connection failed. Try visiting https://susan.com or check https://susan.com/doc for help"
  // then the parsed parts will be ["connection failed. Try visiting ", "https://susan.com", " or check ", "https://susan.com/doc", " for help"]
