...
const (
	...
	claudeDesktopRestoreMessage  = "To restore the usual Claude profile, run: susan launch claude-desktop --restore"
...
func defaultClaudeDesktopOpenApp() error {
	...
	case "windows":
		...
		return errors.New("Claude Desktop executable was not found; open Claude Desktop manually once and re-run 'susan launch claude-desktop --restore'")
	case "darwin":
