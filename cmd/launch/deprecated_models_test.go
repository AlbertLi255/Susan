...
func TestDeprecatedLaunchModelErrorMentionsRecommendedModels(t *testing.T) {
	...
	for _, want := range []string{"qwen2.5-coder:32b does not work well with Codex", "recommended-cloud:cloud", "recommended-local", "susan launch codex --model recommended-cloud:cloud", "Launch with qwen2.5-coder:32b anyway?"} {
