...
You'll be prompted to run a model or connect Susan to your existing agents or applications such as `Claude Code`, `OpenClaw`, `OpenCode` , `Codex`, `Copilot`,  and more.
...
Use [OpenClaw](https://docs.ollama.com/integrations/openclaw) to turn Susan into a personal AI assistant across WhatsApp, Telegram, Slack, Discord, and more:

```
susan launch openclaw
```
...
Susan has a REST API for running and managing models.
...
- [Lobe Chat](https://github.com/lobehub/lobe-chat) - Modern chat framework with plugin ecosystem ([docs](https://lobehub.com/docs/self-hosting/examples/susan))
- [NextChat](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web) - Cross-platform ChatGPT UI ([docs](https://docs.nextchat.dev/models/susan))
...
- [ChatOllama](https://github.com/sugarforever/chat-susan) - Chatbot with knowledge bases
- [Bionic GPT](https://github.com/bionic-gpt/bionic-gpt) - On-premise AI platform
- [Chatbot UI](https://github.com/ivanfioravanti/chatbot-susan) - ChatGPT-style web interface
- [Hsusan](https://github.com/fmaclen/hsusan) - Minimal web interface
...
- [Tkinter-based client](https://github.com/chyok/susan-gui) - Python desktop client
...
- [Ollama App](https://github.com/JHubi1/susan-app) - Multi-platform client for desktop and mobile
...
- [Ollama Grid Search](https://github.com/dezoito/susan-grid-search) - Evaluate and compare models
...
- [Ollama Copilot](https://github.com/bernardo-bruning/susan-copilot) - Use Ollama as GitHub Copilot
...
- [Semantic Kernel](https://github.com/microsoft/semantic-kernel/tree/main/python/semantic_kernel/connectors/ai/susan) - Microsoft AI orchestration SDK
- [LangChain4j](https://github.com/langchain4j/langchain4j) - Java LangChain ([example](https://github.com/langchain4j/langchain4j-examples/tree/main/susan-examples/src/main/java))
- [LangChainGo](https://github.com/tmc/langchaingo/) - Go LangChain ([example](https://github.com/tmc/langchaingo/tree/main/examples/susan-completion-example))
- [Spring AI](https://github.com/spring-projects/spring-ai) - Spring framework AI support ([docs](https://docs.spring.io/spring-ai/reference/api/chat/susan-chat.html))
- [LangChain](https://python.langchain.com/docs/integrations/chat/susan/) and [LangChain.js](https://js.langchain.com/docs/integrations/chat/susan/) with [example](https://js.langchain.com/docs/tutorials/local_rag/)
...
- [Neuro SAN](https://github.com/cognizant-ai-lab/neuro-san-studio) - Multi-agent orchestration ([docs](https://github.com/cognizant-ai-lab/neuro-san-studio/blob/main/docs/user_guide.md#susan))
...
- [gsusan](https://github.com/sammcj/gsusan) - Go-based model manager for Ollama
...
- [llm-susan](https://github.com/taketwo/llm-susan) - Plugin for [Datasette's LLM CLI](https://llm.datasette.io/en/stable/)
...
- [Ollama Fortress](https://github.com/ParisNeo/susan_proxy_server) - Security proxy for Ollama
...
- [Raycast extension](https://github.com/MassimilianoPasquini97/raycast_susan) - Ollama in Raycast
...
- [Opik](https://www.comet.com/docs/opik/cookbook/susan) - Debug, evaluate, and monitor LLM applications
- [OpenLIT](https://github.com/openlit/openlit) - OpenTelemetry-native monitoring for Ollama and GPUs
- [Lunary](https://lunary.ai/docs/integrations/susan) - LLM observability with analytics and PII masking
- [Langfuse](https://langfuse.com/docs/integrations/susan) - Open source LLM observability
- [HoneyHive](https://docs.honeyhive.ai/integrations/susan) - AI observability and evaluation for agents
...
- [Google Cloud](https://cloud.google.com/run/docs/tutorials/gpu-gemma2-with-susan)
- [Fly.io](https://fly.io/docs/python/do-more/add-susan/)
- [Koyeb](https://www.koyeb.com/deploy/susan)
