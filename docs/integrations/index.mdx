...
Use Susan from coding agents, personal assistants, and editors.

Run `susan launch` to see the latest integrations you can run from the terminal.
...
<CardGroup cols={2}>
  <Card title="Claude" href="/integrations/claude-desktop">
    Desktop assistant with local and cloud Susan models.
  </Card>
