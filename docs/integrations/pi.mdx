...
This installs Pi if needed, configures Susan as a provider including web tools, and drops you into an interactive session.

To configure without launching:

```shell
susan launch pi --config
```

### Run directly with a model

```shell
susan launch pi --model qwen3.5:cloud
```

Cloud models are also available at [susan.com](https://susan.com/search?c=cloud).
...
When launching Pi through Susan, package install/update is managed automatically.
To install manually:
