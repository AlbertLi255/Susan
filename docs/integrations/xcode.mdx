...
2. Select **Locally Hosted**, enter port **14343** and click **Add**
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
...
## Connecting to susan.com directly
1. Create an [API key](https://susan.com/settings/keys) from susan.com 
2. Select **Internet Hosted** and enter URL as `https://susan.com`  
3. Enter your **Susan API Key** and click **Add** 