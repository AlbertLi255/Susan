...
1. Open Cline settings > `API Configuration` and set `API Provider` to `Susan`
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    ...
    alt="Cline settings configuration showing API Provider set to Susan"
    width="50%"
  />
</div>
...
1. Create an [API key](https://susan.com/settings/keys) from susan.com
2. Click on `Use custom base URL` and set it to `https://susan.com`
3. Enter your **Susan API Key**
