...
2. Set `API Provider` to `Susan`
3. (Optional) Update `Base URL` if your Susan instance is running remotely. The default is `http://localhost:14343`
...
2. Enable `Use custom base URL` and set it to `https://susan.com`
