...
<Note>
  To use **Susan**,  you will need a [JetBrains AI Subscription](https://www.jetbrains.com/ai-ides/buy/?section=personal&billing=yearly).
</Note>
...
3. Under **Third Party AI Providers**, choose **Susan**  
4. Confirm the **Host URL** is `http://localhost:14343`, then click **Ok**  
5. Once connected, select a model under **Local models by Susan**
