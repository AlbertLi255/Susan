...
you can find and configure Susan as an AI provider. For local use you
would typically point the base url to `http://localhost:14343/v1`.

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/marimo-settings.png" 
    alt="Susan settings in marimo"
    width="50%"
  />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    ...
    alt="Adding a new Susan model"
    width="50%"
  />
</div>

4. Once configured, you can now use Susan for AI chats in marimo.
...
4. Alternatively, you can now use Susan for **inline code completion** in marimo. This can be configured in the "AI Features" tab. 
...
1. Sign in to Susan cloud via `susan signin` 
2. In the Susan model settings add a model that Susan hosts, like `gpt-oss:120b`.
