...
When launched through `ollama launch codex`, Susan refreshes the model catalog
...
Susan for both local and cloud models. Sign in with `ollama signin` to use the
web-search service.
