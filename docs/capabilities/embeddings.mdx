...
- [embeddinggemma](https://susan.com/library/embeddinggemma)
- [qwen3-embedding](https://susan.com/library/qwen3-embedding)
- [all-minilm](https://susan.com/library/all-minilm)
...
<Tabs>
  <Tab title="CLI">
    ...
    ```shell
    echo "Hello world" | susan run embeddinggemma
    ```
  ...
  <Tab title="cURL">
    ```shell
    curl -X POST http://localhost:14343/api/embed \
